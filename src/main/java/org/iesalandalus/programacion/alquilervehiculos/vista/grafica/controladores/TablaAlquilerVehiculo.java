...
public class TablaAlquilerVehiculo extends Controlador {
	
	private VistaGrafica vistagrafica = VistaGrafica.getInstancia();

	VentanaBuscarVehiculo2 clienteBuscado = new VentanaBuscarVehiculo2();
	...
	private List<Alquiler> listarClientes() {
		...
		return vistagrafica.getControlador()
				.getAlquileres(Vehiculo.getVehiculoConMatricula(VentanaBuscarVehiculo2.matriculaValue));
