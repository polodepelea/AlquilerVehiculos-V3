...
public class VehiculoDevolver extends Controlador {
	...
	private void devolverVehiculo() {
		try {
			vistagrafica.getControlador().devolver(Vehiculo.getVehiculoConMatricula(VentanaBuscarVehiculo.matriculaValue), fecha.getValue());
